...
define("REMOTE_REPOSITORY", "https://gitlab.com/accommerce/webapp.git");      // The SSH URL to your repository
define("DIR", "/home/ubuntu/accommerce/webapp");                             // The path to your repostiroy; this must begin with a forward slash (/)
...
define("AFTER_PULL", "/usr/bin/yarn & /usr/bin/yarn build");         // A command to execute after successfully pulling
